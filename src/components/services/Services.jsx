    ...
    <div className="services__container container grid">
      <div className="services__content">
        ...
        <div className={toggleState === 1 ? "services__modal active__modal" : "services__modal"}>
          <div className="services__modal-content">
            ...
            <p className="services__modal-description">Service with more than 1 years of experience.Providing quality work as a Freelancer.</p>
      ...
      <div className="services__content">
        ...
        <div className={toggleState === 3 ? "services__modal active__modal" : "services__modal"}>
          <div className="services__modal-content">
            <i onClick={() => toggleTab(0)} className="uil uil-times services__modal-close"></i>
            <h3 className="services__modal-title">Visula Designer</h3>
            <p className="services__modal-description">Service with more than 1 years of experience.Providing quality work as a Freelancer.</p>
            <ul className="services__modal-services grid">
              <li className="services__modal-service">
                <i className="uil uil-check-circle services__modal-icon"></i>
